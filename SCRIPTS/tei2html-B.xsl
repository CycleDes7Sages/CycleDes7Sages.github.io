...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <title>Transcription du conte B</title>
            ...
            <body><span class="title">
                <i>Transcription du conte conclusif du Roman des Sept Sages de Rome selon la version B</i>
            </span>
                <br/>
                <br/>
    ...
    <xsl:template match="head[@type='rubrique']">
        <h1><span class="headNum"></span><xsl:text> </xsl:text><xsl:apply-templates/></h1>
    </xsl:template>
